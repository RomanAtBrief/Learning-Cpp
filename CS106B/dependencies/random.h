 ...
 * File: random.h
 * ---------------------
 * This iterface exports functions for generating pseudorandom numbers.
 */
 ...
 * ----------------------------------------
 * Returns a random integer in the range lo to high, inclusive.
 */
 ...
 * example, calling randomChance(0.30) returns true 30 percent of the ime
 */
 ...
 * sequence or to ensure that program behaviour is repeatable during the
 * debugging phase.
 */
